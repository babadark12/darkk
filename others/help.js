...
module.exports = {
  ...
  execute(message) {
    ...
    .addField("Moderation", `\`lock\`, \`unlock\`, \`ban\`, \`unban\`, \`mute\`, \`unmute\`, \`count\`, \`emojiinfo\`, \`se\`, \`bans\`, \`embed\`, \`addrole\`, \`rmvrole\`, \`vkick\`, \`clear\`, \`emojilist\`, \`kick\`, \`nick\`, \`rolinfo\`, \`warn\`, \`botlist\`, \`cinvite\`, \`channelinfo\`, \`timelock\``)
