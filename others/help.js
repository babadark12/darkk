...
module.exports = {
  ...
  execute(message) {
    ...
    .addField("🛠️ ❯ Moderation Commands", `\`lock\`, \`unlock\`, \`ban\`, \`unban\`, \`emojiinfo\`, \`se\`, \`bans\`, \`embed\`, \`vkick\`, \`clear\`, \`emojilist\`, \`kick\`, \`warn\`, \`botlist\`, \`cinvite\`, \`channelinfo\`, \`channels\`, \`roleinfo\`, \`timelock\`, \`tempban\`, , \`tempmute\`, \`serverlock\`, \`serverunlock\`, \`nick\`, \`addrole\`, \`rmvrole\``)
