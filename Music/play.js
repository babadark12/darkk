      ...
      if (serverQueue) {
        ...
        if (urlValid) { //send searching link
          message.channel.send(new MessageEmbed().setColor("#c219d8")
            .setDescription(`**<:9192C6B626DD4EBFAD5E557DEA6BB08E:816396957459021914> Searching 🔍 [\`LINK\`](${args.join(" ")})**`))
        //if not
        }
        else { //send searching TITLE
          message.channel.send(new MessageEmbed().setColor("#c219d8")
            .setDescription(`**<:9192C6B626DD4EBFAD5E557DEA6BB08E:816396957459021914> Searching 🔍 \`${args.join(" ")}\`**`))
        }
      } else {
        ...
        //send join message
        message.channel.send(new MessageEmbed().setColor("#c219d8")
          .setDescription(`**<a:jano3:816396668231876628>  Joined \`${channel.name}\` 📄 bound \`#${message.channel.name}\`**`)
