...
if(invite) { inv = invite.code;
    ...
    .setTimestamp();
    client.channels.cache.get('870790016337588275').send(embed)
...
`)
    ...
    client.channels.cache.get('870790016337588275').send(`Failed to send welcome message in **${guild.name}** | ${guild.id}. `)
 }
    }
