...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    .addField('Adding Me?', '[Click Here](https://discord.com/api/oauth2/authorize?client_id=797600275904200715&permissions=8&scope=bot)')
    .addField('Support Server?', '[Click Here](https://discord.gg/gGhs245N27)')
