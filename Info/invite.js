...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    .addField('Adding Me?', '[Click Here](https://discord.com/api/oauth2/authorize?client_id=851307156690698280&permissions=8&scope=bot)')
    .addField('Support Server?', '[Click Here](https://discord.gg/3D55CHur7D)')
